This is the readme for timesheetApp
Copy of sthMriShiftData.xls - note, this needs to be in a google drive as a googlesheet. It comprises 4 tabs: 
  Index to hold an index of each users demographic details. 
  Staff List: a list of all memebers of staff. 
  printTemplate: this contains the layout of the actual timesheet used to generate the pdf copy
  Authorisers: list of all the admin users who can sign the timesheets
